    ...
    @foreach ($events as $event)
      <div class="col-md-4 mb-4">
        <div class="card h-100 shadow-sm">
          ...
          @else
            <img src="https://via.placeholder.com/400x200?text=Event" class="card-img-top" alt="Event Placeholder">
          @endif
          <div class="card-body d-flex flex-column">
            <h5 class="card-title">{{ $event->title }}</h5>
            <p class="card-text text-muted mb-1"><strong>Date:</strong> {{ $event->date }}</p>
